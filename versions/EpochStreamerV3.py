...
current_prompt = "Highly detailed Centered Science fiction image of a star-gate with semi transparent space creatures similar to mythical sea monsters, swimming in space, surrounded with stars, planets, nebula, dust and space debris>"
...
<button class="btn-green" onclick="window.open('/media', '_blank')">
    ...
    <div class="column right">
        ...
        <input type="number" id="logo_width_input" value="100" min="10" max="1000" oninput="changeLogoSize()" onchange="saveLogoPosition()">
        <label>Opacity</label>
        <input type="range" id="logo_opacity_slider" min="0" max="1" step="0.05" value="1.0" oninput="updateLogoOpacity(this.value)" onchange="saveLogoPosition()">
        ...
        function initDraggableLogo() {
            ...
            dragLogoEl.addEventListener("pointerup", (e) => {
                if (isDraggingLogo) {
                    ...
                    // Autosave the dropped position to the server
                    saveLogoPosition();
                }
            });
        }
